...
<div class="navig">
	...
	<div class="menu" align="right">			
				...
				<a href="changepassword.jsp" name="${i}"></a>
...
<div class="product-filter">
		...
		<div class="product-card">
			<a href="purchase.jsp"><div class="product-image">
				<h3></h3>
				<img src="./images/Wm1.jpg"width="400" height="300">
			</div>
			<div class="product-info">
				<h5 name="proinfo">IFB 7 kg 3D Wash Technology, CradleWash, Aqua Energie, In-built heater Fully Automatic Front Load with In-built Heater Black, White  (Neo Diva BX 7 kg)</h5>
				<h6 name="price">Rs.33,610</h6>
				<br>
			</div></a>
		</div>
