...
<form method="get" id="home" action="buyproducts.jsp">
			<a href="buyproducts"><h2 align="left" style="font-weight:bold;color:black;">Return Home</h2></a>
		</form>		
<div class="container">
  <div id="Checkout" class="inline">
      ...
      <form action="payment" method="POST">
          ...
          <div class="form-group">
              <label for="PaymentAmount">Product:<h4>${param.proName}
              <input type="hidden" name="proName" value="${param.proName}"></h4></label>
              <div class="amount-placeholder">
              </div>
          </div>
          <div class="form-group">
              <label for="PaymentAmount">Payment amount:<h4>${param.price}</h4></label>
          ...
          <div class="form-group">
              ...
              <input id="NameOnCard" class="form-control" name="cardName" type="text" maxlength="255"></input>
          </div><br>
          <div class="form-group">
              <label for="CreditCardNumber">Card number</label>
              <input id="CreditCardNumber" class="null card-image form-control" name="cardNo" type="text"></input>
          </div><br>
           <div class="form-group">
              <label for="Phone Number">Phone number</label>
              <input id="Phone number" class="null card-image form-control" name="phone" type="text"></input>
          </div><br>
          ...
          <div class="zip-code-group form-group">
              ...
              <div class="input-container">
                  <input id="ZIPCode" class="form-control" name="zipcode" type="text" maxlength="10"></input>
